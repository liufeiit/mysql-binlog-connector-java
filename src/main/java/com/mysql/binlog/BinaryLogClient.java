...
import com.mysql.binlog.event.EventData;
import com.mysql.binlog.event.EventHeader;
import com.mysql.binlog.event.EventHeaderV4;
import com.mysql.binlog.event.EventType;
import com.mysql.binlog.event.GtidEventData;
import com.mysql.binlog.event.RotateEventData;
import com.mysql.binlog.event.deserialization.ChecksumType;
import com.mysql.binlog.event.deserialization.EventDataDeserializationException;
import com.mysql.binlog.event.deserialization.EventDataDeserializer;
import com.mysql.binlog.event.deserialization.EventDeserializer;
import com.mysql.binlog.event.deserialization.GtidEventDataDeserializer;
import com.mysql.binlog.event.deserialization.RotateEventDataDeserializer;
import com.mysql.binlog.io.ByteArrayInputStream;
import com.mysql.binlog.jmx.BinaryLogClientMXBean;
import com.mysql.binlog.network.AuthenticationException;
import com.mysql.binlog.network.ServerException;
import com.mysql.binlog.network.SocketFactory;
import com.mysql.binlog.network.protocol.ErrorPacket;
import com.mysql.binlog.network.protocol.GreetingPacket;
import com.mysql.binlog.network.protocol.PacketChannel;
import com.mysql.binlog.network.protocol.ResultSetRowPacket;
import com.mysql.binlog.network.protocol.command.AuthenticateCommand;
import com.mysql.binlog.network.protocol.command.Command;
import com.mysql.binlog.network.protocol.command.DumpBinaryLogCommand;
import com.mysql.binlog.network.protocol.command.DumpBinaryLogGtidCommand;
import com.mysql.binlog.network.protocol.command.PingCommand;
import com.mysql.binlog.network.protocol.command.QueryCommand;
...
public class BinaryLogClient implements BinaryLogClientMXBean {
    ...
    private void ensureEventDataDeserializer(EventType eventType,
             Class<? extends EventDataDeserializer<? extends EventData>> eventDataDeserializerClass) {
        EventDataDeserializer<? extends EventData> eventDataDeserializer = eventDeserializer.getEventDataDeserializer(eventType);
        if (eventDataDeserializer.getClass() != eventDataDeserializerClass &&
            ...
            EventDataDeserializer<? extends EventData> internalEventDataDeserializer;
            try {
